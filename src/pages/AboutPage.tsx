    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="bg-gradient-hero py-20 text-center">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-5xl md:text-6xl font-bold text-primary-foreground mb-6">About Devnzo</h1>
          <p className="text-xl text-primary-foreground/80 max-w-3xl mx-auto">
            We're on a mission to empower businesses worldwide with innovative technology solutions that drive
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-6">
                At Devnzo, we believe every business deserves access to powerful, enterprise-grade tools that were once
                only available to large corporations. Our mission is to democratize technology and empower businesses of
                all sizes to compete and succeed in the digital age.
              </p>
              <p className="text-lg text-muted-foreground">
                Since our founding, we've helped over 50,000 businesses across 150+ countries transform their
                operations, increase efficiency, and achieve remarkable growth.
              </p>
            </div>

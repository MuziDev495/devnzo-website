...
const SocialIcon = ({ iconType, className }: { iconType: string; className?: string }) => {
  ...
  const normalizedIconType = iconType.toLowerCase().trim();

  switch (normalizedIconType) {
    case "twitter":
      return (
